...
<div class="content-box">
    <div id="showFilters" class="left">
        <button class="filterButton" onclick="showFilters(); return false;">More Filters</button>
    </div>
    <div id="hideFilters" class="left">
        <button class="filterButton" onclick="hideFilters(); return false;">Hide Filters</button>
    </div>
    <?php
