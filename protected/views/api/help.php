...
$tmp .= addLine("# tag : Usage : tag \"Exertus vs Archaea\", Use during game, resets when game starts. Searchable on web.");
$tmp .= addLine("# es : Show extended scoreboard. Opens window and shows extended stats for players playing on the server.");
